...
//		vProjected.y *= -1.0f;
	...
	public int Render2(List<Triangle> triangles) {
		return Render2(triangles, RENDER_CULL_CW | RENDER_TEXTURED | RENDER_DEPTH);
	}

	public int Render2(List<Triangle> triangles, int flags) {
		this.flags = flags;
